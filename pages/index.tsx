					...
					<div className="flex flex-row max-w-screen-lg mx-auto xl:max-w-screen-xl">
						...
						<div className="p-5 prose prose-xl md:prose-lg lg:prose-xl max-w-none md:max-w-3xl">
							...
							<p>
								...
								this by instilling a culture of reciprocal improvment and cherishing for
						...
						<div className="flex flex-row items-center mt-10">
							<div className="p-5 prose prose-xl md:prose-lg lg:prose-xl max-w-none md:max-w-3xl">
								...
								<p>
									...
									defined objectives, that are any length but usually last up to one hour
									on average each. When a mission is selected, we ask for volunteers to
									lead the mission — anyone can step up.
								</p>
								<p>
...
function WideCard(image, marginTop) {
	return (
		...
		>
			<Image alt="Mountains" src={image} layout="fill" objectFit="cover" />
		</div>
	);
}
